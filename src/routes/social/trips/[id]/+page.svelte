<svelte:head>
	...
	<meta
		name="description"
		content={data.trip
			? `Oeffentliche Reise von ${data.trip.ownerName}: ${data.trip.place} ${data.trip.year}.`
			: 'Oeffentliche Reise konnte im TravelJournal nicht gefunden werden.'}
	/>
</svelte:head>
	...
	<div class="detail-container container-xxl">
		{#if data.trip}
			<TripHeader
				...
				showFollow
				isFollowing={data.trip.isFollowing}
			/>
			...
			<div class="detail-layout">
				...
				<div class="info-block">
					<div class="left-column">
						<BudgetPanel trip={data.trip} readonly />
						<SchedulePanel trip={data.trip} />
					</div>
					<div class="right-column">
						<CommentsPanel
							trip={data.trip}
							commentError={form?.errors?.comment}
							allowAllDeletes={false}
